# <img src = "https://raw.githubusercontent.com/MartinHeinz/MartinHeinz/master/wave.gif" width = 30px> Hi there! ![Total profile views](https://komarev.com/ghpvc?username=code-dreamer-xyz&color=blueviolet) [![Analytics](https://ga-beacon.atanas.info/api/analytics?account=UA-83446952-1&page=github.com/code-dreamer-xyz/codedreamer615&pixel)](https://github.com/code-dreamer-xyz/code-dreamer-xyz/)

## 💻 About Me 
<h5>I'm a Senior React Developer with over 5 years of experience building interactive and scalable user interfaces using React and its ecosystem. I'm passionate about creating clean, maintainable, and efficient code that delivers an exceptional user experience. My expertise includes React, Redux, React Router, TypeScript, and GraphQL. I also have experience with server-side rendering, performance optimization, and testing frameworks like Jest and Enzyme. As a team player, I enjoy collaborating with other developers, designers, and stakeholders to deliver high-quality web applications that meet business requirements.</h5>
